...
def mostrar(frame, nome, cardapio):
    ...
    tk.Button(frame1, width=25, text=cardapio[3][0], font=fontep, command=lambda:adicionar(frame2, cardapio[3][0],cardapio[3][1])).pack()
    tk.Button(frame1, width=25, text=cardapio[4][0], font=fontep, command=lambda:adicionar(frame2, cardapio[4][0],cardapio[4][1])).pack()
...
def Ultimas_compras(frame):
    ...
    for i in range (len(historico)):
        #mensagem = mensagem + "item " + str(i) +  ": R$ " + str(historico[i]) + ",00 \n"  
